...
const FormBlock = () => {
    ...
    const onSubmit = (e: FormEvent) => {
        ...
        sendData({
            ...
            setThanksMessage(
                "Great, that worked! Your information has been received successfully. The AGA or one of her contributors will be in contact with you soon to further discuss your inquiry. Have a wonderful day!",
            ),
        );
    ...
    return (
        <div className={styles.wrapper}>
            <h2 className={styles.title}>Fill in the form below to join AGA</h2>
